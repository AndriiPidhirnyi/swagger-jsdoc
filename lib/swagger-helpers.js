...
function swaggerizeObj(swaggerObject) {
  ...
  swaggerObject.pathPrefix = swaggerObject.pathPrefix || '';
...
function _organizeSwaggerProperties(swaggerObject, pathObject, propertyName) {
  ...
  // Paths.
    ...
    swaggerObject.paths[swaggerObject.pathPrefix + propertyName] = _objectMerge(
      swaggerObject.paths[swaggerObject.pathPrefix + propertyName], pathObject[propertyName]
    );
  }
}
